...
func Benefits() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div><div class=\"w-full\"><h2 class=\"text-2xl mb-8 font-medium\">Why you will love ThinkLedger</h2></div><div class=\"grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8\">")
		if templ_7745c5c3_Err != nil {
		...
		for _, benefit := range benefits {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/components/benefits.templ`, Line: 55, Col: 31}
			}
